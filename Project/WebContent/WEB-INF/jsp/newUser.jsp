		...
		<form action="NewUserResult" method="post">
			<div class="newUser-input-area">
				<div class="form-group row">
					...
					<input type="text" name="loginId" class="form-control col-sm-7" id="loginId" pattern="^[0-9A-Za-z]+$" placeholder="半角英数のみ" value="${loginId}" maxlength="20">
				</div>
				<div class="form-group row">
					<label for="userName" class="col-sm-4 text-center">ユーザー名</label>
					<input type="text" name="name" class="form-control col-sm-7" id="userName" value="${userName}" maxlength="20">
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<input type="text" name="password" class="form-control col-sm-7" id="password" pattern="^[0-9A-Za-z]+$" placeholder="半角英数のみ">
				</div>
				<div class="form-group row">
					<label for="passwordCheck" class="col-sm-4 text-center">パスワード(確認)</label>
					<input type="password" name="passwordCheck" class="form-control col-sm-7" id="passwordCheck">
				</div>
			</div>
